...
import { updateCartItem } from '../../store/actions/user-actions';
import { useTranslation } from 'react-i18next';

const AddToCart = ({ item, layout, notificationService, updateCartItem }) => {
  ...
  const handleClick = () => {
    ...
    notificationService.notify( t('interface.messages.productAddedToCart') );
  };

  if (layout === 'icon') {
    return (
      <button className="add-to-cart add-to-cart--sm" onClick={handleClick}>
